In diesem Abschnitt werden wir uns drei Fragen stellen:
	...
	\section{Maße und Inhalte}
		...
		\subsection{Approximationssätze und Regularität}
			...
			\begin{satz}
				Sei $\mathfrak{C}$ ein Mengensystem über $\Omega_2$, das $\mathfrak{S}_2$ erzeugt, $\mathfrak{S}_2=\mathfrak{A}_\sigma(\mathbb{C}$, dann ist $f:\Omega_1\to\Omega_2$ $\mathfrak{S}_1-\mathfrak{S}_2$-messbar genau dann, wenn
		...
		\section{Konvergenzarten}
			...
			\begin{defi}
				Sei $P$ eine Aussage und $(\Omega,\mf{S}, \mu)$ ein Maßraum. Wir sagen, $P$ gilt fast überall oder fast sicher, wenn es eine Menge $N\in\mf{S}$, $\mu(N)=0$ gibt mit $P(\omega)$ für fast alle $\omega \in N^c$.
			\end{defi}
